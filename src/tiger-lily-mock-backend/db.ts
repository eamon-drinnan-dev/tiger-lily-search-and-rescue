...
const k9Unit1: K9Unit = {
  ...
  notes: 'German Shepherd, 6 years old, certified SAR (Handler: Sarah Chen)',
  createdAt: hoursAgo(4),
...
const k9Unit2: K9Unit = {
  ...
  notes: 'Border Collie, 4 years old, high energy (Handler: Marcus Rodriguez)',
...
const k9Unit3: K9Unit = {
  ...
  notes: 'Bloodhound, 7 years old, veteran SAR dog (Handler: Emma Thompson)',
...
const k9Unit4: K9Unit = {
  ...
  capabilities: [K9Capabilities.AIRSCENT],
  notes: 'Golden Retriever, 5 years old (Handler: James Park)',
  createdAt: hoursAgo(2),
